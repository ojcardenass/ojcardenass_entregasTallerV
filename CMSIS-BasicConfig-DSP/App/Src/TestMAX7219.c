...
void init_MAX7219(void){
	send_to_MAX7219(&handlerSPI,DECO_MODE, NO_DECO);
	send_to_MAX7219(&handlerSPI,INTENSITY, 0x02);
	send_to_MAX7219(&handlerSPI,SCAN_LIMIT,5);
	send_to_MAX7219(&handlerSPI,SHUTDOWN, NORMAL);
	send_to_MAX7219(&handlerSPI,DISPLAY_TEST, NO_TEST);
	send_to_MAX7219(&handlerSPI,DIGIT0, 0x81);
	send_to_MAX7219(&handlerSPI,DIGIT1, 0x42);
	send_to_MAX7219(&handlerSPI,DIGIT2, 0x24);
	send_to_MAX7219(&handlerSPI,DIGIT3, 0x18);
	send_to_MAX7219(&handlerSPI,DIGIT4, 0x18);
	send_to_MAX7219(&handlerSPI,DIGIT5, 0x24);
	send_to_MAX7219(&handlerSPI,DIGIT6, 0x42);
	send_to_MAX7219(&handlerSPI,DIGIT7, 0x81);
	clearDisplay_MAX7219(&handlerSPI);
